...
import svgPaths from "../../imports/svg-t929zus66l";
...
export default function InteractiveLogin({ onLogin, onGoogleLogin, onSwitchToCadastro }: InteractiveLoginProps) {
  ...
  return (
    <div className="bg-white relative size-full" data-name="Login">
      ...
      <div className="absolute h-[61px] left-[40px] top-[171px] w-[350px]" data-name="Login/cadastro">
        ...
        <button 
          className="absolute bg-[#f8c78d] inset-[10.29%_55.14%_10.29%_2%] rounded-[35px] cursor-pointer"
          onClick={() => {}}
        />
        <button 
          className="absolute content-stretch flex inset-[27.94%_29.57%_27.94%_-23.57%] items-center justify-center cursor-pointer"
          onClick={() => {}}
        >
        ...
        <button 
          className="absolute content-stretch flex inset-[27.94%_-22.71%_27.94%_28.71%] items-center justify-center cursor-pointer hover:opacity-80 transition-opacity"
      ...
      <form onSubmit={handleSubmit}>
        ...
        {/* Password Input */}
        <div className="absolute content-stretch flex flex-col gap-[5px] h-[93px] items-start left-[32px] px-[13px] py-px top-[339px] w-[366px]" data-name="Input Login">
          ...
          <button 
            type="button"
            className="font-['Poppins:Medium',sans-serif] leading-[normal] not-italic text-[12px] text-[#a3a3a3] hover:text-[#6f9a7c] transition-colors mt-2"
          >
            Esqueci minha senha
          </button>
        </div>
        ...
        <button 
          type="submit"
          className="absolute bg-[#f8c78d] h-[43px] left-[45px] rounded-[20px] shadow-[0px_4px_9px_0px_rgba(0,0,0,0.15)] top-[452px] w-[340px] hover:bg-[#f7bb7a] transition-colors cursor-pointer"
        >
      ...
      {/* Divider */}
      <div className="absolute h-[15px] left-[35px] top-[510px] w-[360px]" data-name="Input Login/Barra 'ou'">
      ...
      <button 
        ...
        className="absolute h-[43px] left-[45px] top-[540px] w-[340px] hover:opacity-90 transition-opacity cursor-pointer"
      >
